...
save(fgseaRes, file="OS_36vs12_pathways.Rdata")
write.csv(x=output1,"OS_36vs12_pathways.csv")
write.table(output1, file = "OS_36vs12_pathways.txt", row.names = F, sep = "\t", quote = F)
write_xlsx(fgseaRes,"C:/Users/Admin/Desktop/R Studio for Bulk and Single Cell Analysis/Puleo Microarray/OS_36_vs_12_FGSEA\\OS_36vs12_pathways.xlsx")
...
save(fgseaRes2, file="OS_36vs12_geneontology.Rdata")
...
write_xlsx(fgseaRes2,"C:/Users/Admin/Desktop/R Studio for Bulk and Single Cell Analysis/Puleo Microarray/OS_36_vs_12_FGSEA\\OS_36vs12_geneontology.xlsx")
...
#A table plot
topPathwaysUp3 <- fgseaRes3[ES > 0][head(order(pval), n=10), pathway]
topPathwaysDown3 <- fgseaRes3[ES < 0][head(order(pval), n=10), pathway]
...
#Saving the fgsea results for the Pathways analysis
save(fgseaRes3, file="OS_36vs12_Remy.Rdata")
write.csv(x=output3,"OS_36vs12_Remy.csv")
write.table(output3, file = "OS_36vs12_Remy.txt", row.names = F, sep = "\t", quote = F)
write_xlsx(fgseaRes3,"C:/Users/Admin/Desktop/R Studio for Bulk and Single Cell Analysis/Puleo Microarray/OS_36_vs_12_FGSEA\\OS_36vs12_Remy.xlsx")
#Importing the saved table
