...
Using cluster comparison metrics like the adjusted Rand index (ARI) and normalised mutual information (NMI), we evaluate the performance of our clustering approach. This statistical analysis helps validate the clustering results against known labels or pathologies.
