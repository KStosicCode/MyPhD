...
### Questions
- What is the name of the first gene in the count matrix?
- What is the barcode of the first cell in the count matrix?
- What is the count of the first gene in the first cell?
- How many counts in the count matrix?
- How many counts are equal to 0?
- Is gene Xcr1 expressed in second cell?
- Which database to search for data set GSE166635?
- How many samples in this data set?
- Where to download the count matrix of the first sample?
