...
cont.matrix <- makeContrasts(LongerOS_vs_ShorterOS=MoreThan36Months-LessThan18Months,
                             levels=design)
cont.matrix
dim(cont.matrix)
...
save(top.table2, file="OS_36vs18_toptable.Rdata")
write.csv(x=top.table2,"OS_36vs18_toptable.csv")
write.table(top.table2, file = "OS_36vs18_toptable.txt", row.names = F, sep = "\t", quote = F)
write_xlsx(top.table2,"C:/Users/Admin/Desktop/R Studio for Bulk and Single Cell Analysis/Puleo Microarray/OS_36_vs_18_DGE\\OS_36vs18_toptable.xlsx")
#Importing the saved table
w <- read.delim("OS_36vs18_toptable.txt")

#Up and down regulated genes in LongerOS vs ShorterOS for OS 36 vs 18
library(dplyr)
...
#Saving the top table for Up regulated genes for OS 36 vs 18
save(LongerOS_vs_ShorterOS_up,file="OS_36vs18_lfc1_up.Rdata")
write.csv(x=LongerOS_vs_ShorterOS_up,"OS_36vs18_lfc1_up.csv")
write.table(LongerOS_vs_ShorterOS_up, file = "OS_36vs18_lfc1_up.txt", row.names = F, sep = "\t", quote = F)
write_xlsx(LongerOS_vs_ShorterOS_up,"C:/Users/Admin/Desktop/R Studio for Bulk and Single Cell Analysis/Puleo Microarray/OS_36_vs_18_DGE\\OS_36vs18_lfc1_up.xlsx")

#Saving the top table for Down regulated genes for OS 36 vs 18
save(LongerOS_vs_ShorterOS_down,file="OS_36vs18_lfc1_down.Rdata")
write.csv(x=LongerOS_vs_ShorterOS_down,"OS_36vs18_lfc1_down.csv")
write.table(LongerOS_vs_ShorterOS_down, file = "OS_36vs18_lfc1_down.txt", row.names = F, sep = "\t", quote = F)
write_xlsx(LongerOS_vs_ShorterOS_down,"C:/Users/Admin/Desktop/R Studio for Bulk and Single Cell Analysis/Puleo Microarray/OS_36_vs_18_DGE\\OS_36vs18_lfc1_down.xlsx")
