...
index=which(metadata$OS=="LessThan12Months")



#Plotting 
#B cells naive
ggplot(metadata,aes(OS,B.cells.naive)) + 
  geom_boxplot() +
  ggtitle("B cells naive") +
  theme(plot.title = element_text(hjust=0.5)) +
  stat_compare_means() 

bn <- ggplot(metadata,aes(OS,B.cells.naive)) + 
  geom_boxplot() +
  ggtitle("B cells naive") +
  theme(plot.title = element_text(hjust=0.5)) +
  geom_signif(comparisons = list(c("LessThan12Months", "MoreThan36Months")), 
...
#B cells memory 
bm <- ggplot(metadata,aes(OS,B.cells.memory)) + 
  geom_boxplot() +
...
#Plasma cells
pc <- ggplot(metadata,aes(OS,Plasma.cells)) + 
  geom_boxplot() +
...
t_cd8 <- ggplot(metadata,aes(OS, T.cells.CD8)) + 
  geom_boxplot() +
  ggtitle("T cells CD8+") +
  theme(plot.title = element_text(hjust=0.5)) +
  geom_signif(comparisons = list(c("LessThan12Months", "MoreThan36Months")), 
...
t_cd4_n <- ggplot(metadata,aes(OS, T.cells.CD4.naive)) + 
  geom_boxplot() +
...
ggplot(metadata,aes(OS, T.cells.CD4.memory.resting)) + 
  geom_boxplot() +
...
t_cd4_m_r <- ggplot(metadata,aes(OS, T.cells.CD4.memory.resting)) + 
  geom_boxplot() +
  ggtitle("T cells CD4+ Memory Resting") +
  theme(plot.title = element_text(hjust=0.5)) +
  geom_signif(comparisons = list(c("LessThan12Months", "MoreThan36Months")), 
...
t_cd4_m_a <- ggplot(metadata,aes(OS, T.cells.CD4.memory.activated)) + 
  geom_boxplot() +
...
t_f_h <- ggplot(metadata,aes(OS,T.cells.follicular.helper)) + 
  geom_boxplot() +
...
t_reg <- ggplot(metadata,aes(OS,T.cells.regulatory..Tregs.)) + 
  geom_boxplot() +
...
#T cells gamma delta
t_g_d <- ggplot(metadata,aes(OS,T.cells.gamma.delta)) + 
  geom_boxplot() +
...
#NK cells resting
nk_r <- ggplot(metadata,aes(OS,NK.cells.resting)) + 
  geom_boxplot() +
...
#NK cells activated
nk_a <- ggplot(metadata,aes(OS,NK.cells.activated)) + 
  geom_boxplot() +
...
#Monocytes
monocytes <- ggplot(metadata,aes(OS,Monocytes)) + 
  geom_boxplot() +
  ggtitle("Monocytes") +
  theme(plot.title = element_text(hjust=0.5)) +
  geom_signif(comparisons = list(c("LessThan12Months", "MoreThan36Months")), 
...
#Macrophages M0
m_m0 <- ggplot(metadata,aes(OS, Macrophages.M0)) + 
  geom_boxplot() +
...
#Macrophages M1
m_m1 <- ggplot(metadata,aes(OS, Macrophages.M1)) + 
  geom_boxplot() +
...
#Macrophages M2
m_m2 <- ggplot(metadata,aes(OS, Macrophages.M2)) + 
  geom_boxplot() +
...
dendritic_r <- ggplot(metadata,aes(OS,Dendritic.cells.resting)) + 
  geom_boxplot() +
...
dendritic_a <- ggplot(metadata,aes(OS,Dendritic.cells.activated)) + 
  geom_boxplot() +
...
#Mast cells resting
mast_r <- ggplot(metadata,aes(OS, Mast.cells.resting)) + 
  geom_boxplot() +
...
mast_a <- ggplot(metadata,aes(OS, Mast.cells.activated)) + 
  geom_boxplot() +
...
#Eosinophils
eosinophils <- ggplot(metadata,aes(OS, Eosinophils)) + 
  geom_boxplot() +
  ggtitle("Eosinophils") +
  theme(plot.title = element_text(hjust=0.5)) +
  geom_signif(comparisons = list(c("LessThan12Months", "MoreThan36Months")), 
...
#Neutrophils
neutrophils <- ggplot(metadata,aes(OS, Neutrophils)) + 
  geom_boxplot() +
  ggtitle("Neutrophils") +
  theme(plot.title = element_text(hjust=0.5)) +
  geom_signif(comparisons = list(c("LessThan12Months", "MoreThan36Months")), 
